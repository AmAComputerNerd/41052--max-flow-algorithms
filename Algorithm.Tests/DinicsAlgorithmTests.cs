...
[TestClass]
public sealed class DinicsAlgorithmTests
{
    [TestMethod]
        public void FindMaxFlow_StandardGraph_ReturnsCorrectFlow()
        {
            ...
            var dinics = new Dinics(graph);

            // Act
            var maxFlow = dinics.FindMaxFlow();
        ...
        public void FindMaxFlow_AfterResetFlow_ReturnsOriginalFlow()
        {
            ...
            graph.AddEdge("S", "A", 10);
            graph.AddEdge("A", "T", 10);
            var algorithm1 = new Dinics(graph);

            // Act
            var maxFlow1 = algorithm1.FindMaxFlow();
            graph.ResetFlow();
            var algorithm2 = new Dinics(graph);
